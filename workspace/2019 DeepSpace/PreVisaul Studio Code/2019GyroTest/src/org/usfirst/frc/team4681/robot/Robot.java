...
public class Robot extends TimedRobot {
	...
	String gyroThetaS;
	Victor motorR0,motorR2;
	Victor motorL1,motorL3;
	Victor motorTest;
	Joystick controller;
	boolean Rturn;
	boolean Lturn;
	...
	public void robotInit() {
		...
		gyro.calibrate();
		turn=0;
		motorR0 = new Victor(0);
		motorR2 = new Victor(2);
		motorL1 = new Victor(1);
		motorL3 = new Victor(3);
		controller = new Joystick(0);
	}
	
	public void tankDrive(double rVel0, double rVel2, double lVel1, double lVel3 ) {
		motorR0.set(rVel0/.8);
		motorR2.set(rVel2/.8);
		motorL1.set(lVel1/.8);
		motorL3.set(lVel3/.8);
